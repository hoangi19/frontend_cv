...
function About()
{
    const Content = () => {
        return (
            <React.Fragment>
                <h2 className="contact text-white my-3">About Me</h2>
                <Info />
                <div className="row my-5">
                    <div className="col-lg-6 col-md-6">
                        <h3 className="contact text-white my-3">Services and Solutions</h3>
                    ...
                    <div className="col-lg-6 col-md-6">
                        <h3 className="contact text-white my-3">Personal Information</h3>
